...
static void MX_I2C3_Init(void)
{
  ...
  */
  ...
  /* I2C3 autonomous mode configured by LPBAM Scenario (MX_LpbamAp1_Scenario_Build) */
...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  /** Enable the WakeUp
  */
  if (HAL_RTCEx_SetWakeUpTimer_IT(&hrtc, 1, RTC_WAKEUPCLOCK_RTCCLK_DIV16, 0) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, HOLD_PWR_Pin|CSB_Trig_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_RED_GPIO_Port, LED_RED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, OLED_SCK_Pin|LED_GREEN_Pin|OLED_SDA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : HOLD_PWR_Pin CSB_Trig_Pin */
  GPIO_InitStruct.Pin = HOLD_PWR_Pin|CSB_Trig_Pin;
  ...
  /*Configure GPIO pins : OLED_SCK_Pin LED_GREEN_Pin OLED_SDA_Pin */
  GPIO_InitStruct.Pin = OLED_SCK_Pin|LED_GREEN_Pin|OLED_SDA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
